...
REACH_CONVERGENCE_1=${REACH_CONVERGENCE_1:"False"}
MSE_EPSILON_1=${MSE_EPSILON_1:1e-4}
TRAIN_EPOCHS_1=${TRAIN_EPOCHS_1:1}
TRAIN_ITERS_LEGIT_1=${TRAIN_ITERS_LEGIT_1:30000}

REACH_CONVERGENCE_2=${REACH_CONVERGENCE_2:"False"}
ACC_EPSILON_2=${MSE_EPSILON_2:1e-4}
TRAIN_EPOCHS_2=${TRAIN_EPOCHS_2:1}
TRAIN_ITERS_ADV_2=${TRAIN_ITERS_ADV_2:30000}

REACH_CONVERGENCE_3=${REACH_CONVERGENCE_3:"False"}
MSE_EPSILON_3=${MSE_EPSILON_3:1e-4}
ACC_EPSILON_3=${ACC_EPSILON_3:1e-3}
TRAIN_EPOCHS_3=${TRAIN_EPOCHS_3:40}
TRAIN_ITERS_LEGIT_3=${TRAIN_ITERS_LEGIT_3:500}
TRAIN_ITERS_ADV_3=${TRAIN_ITERS_ADV_3:8000}
